...
**日期**: 2026-03-15
**功能**: 终端连接状态显示与断线通知
**实施状态**: ✅ 已完成（`terminal_status_bar.dart` 与配套测试已落地）
...
- [x] 每个终端标签页下方显示独立状态栏
- [x] SSH 连接状态栏显示：连接状态、延迟、时长、服务器
- [x] 本地终端状态栏显示：状态、时长、"Local"
- [x] 连接中状态：黄色指示器
- [x] 已连接状态：绿色指示器
- [x] 断开状态：红色背景 + "已断开" + 重连按钮
- [x] 断线时显示 SnackBar 消息 "连接已断开"
- [x] 点击重连按钮可重新连接
- [x] 使用 Flutter Theme 颜色，与深色/浅色主题一致
