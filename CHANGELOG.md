...
- test(sync-settings): cover config rendering, save and sync actions (cde21f1)
- test(import-export-settings): cover stats, export and import flows (04e102c)
- test(connection-form): tap dropdown instead of label to fix hit-test warning (21170a0)
